CREATE TABLE HIVAS(hivasId INT PRIMARY KEY, idopont TIMESTAMP, hivo varchar2(15), helyszin varchar2(30), leiras varchar2(50));

CREATE TABLE NAPLO(naploId INT PRIMARY KEY, kierkezes TIMESTAMP, felhasznalo varchar2(20), sikeres boolean, hivasId int, FOREIGN KEY (hivasId) REFERENCES HIVAS(hivasId));
